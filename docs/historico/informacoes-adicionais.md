...
## 2026-03-25. Novo comando `/quiz`. Gerador de Quiz de Vendas (Low Ticket)
...
- Essa regra se aplica ao funil de quiz (Low Ticket / low ticket). Páginas de vendas geradas pelo comando `/pagina-de-vendas` seguem a regra própria daquela skill (vídeo obrigatório na primeira dobra).
...
- As 7 leis de copy low ticket estão explicitadas no comando (ensinar em vez de prometer, nomear cria realidade, produto não aparece no lead, etc.)
...
`/paginas-low-ticket`. Gerar as 4 leads low ticket (Inadequação, Identificação, Plug & Play, Promessa Boa Demais)
...
## 2026-03-26. Estratégia de uso das 4 leads low ticket com os mentorados
...
- Além das 4 leads, ainda existe o quiz (Low Ticket) como mais uma opção de funil
