...
- `/trafego-escalar`. Escala de campanhas validadas.
...
- `/trafego-otimizar`. Diagnóstico em 2 camadas (tendência + gargalo) para 6 trilhas (perpétuo low/mid/high, lançamento low/mid/high). Emite sinal de prontidão para escala
- `/trafego-escalar`. Escalar campanhas validadas com 4 modos (vertical, horizontal, vertical+horizontal, CBO) e 3 velocidades. Aplica freios escalonados e devolve handoff para otimização quando freio total aciona
