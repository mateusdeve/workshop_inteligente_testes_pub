# Estruturas de VSL (Video Sales Letter)
...
- "Se você [situação do público], precisa ver isso até o final"
- "Eu descobri algo que mudou completamente [resultado]"
...
- Use a linguagem exata que o público usa
...
- Consequências emocionais, financeiras, de saúde
...
- Jornada: fracasso → descoberta → transformação
...
- Explique POR QUE funciona (diferente de tudo que já tentou)
...
- Bônus com valores individuais
- Stack de valor: "Valor total: R$ X.XXX"
...
- Reforce a garantia
- Crie urgência (escassez real)
- CTA direto: "Clique no botão abaixo agora"
- Último empurrão: "O que vai mudar se você não agir hoje?"

---

## Estrutura Curta para Reels/Stories (60 segundos)

1. **Gancho** (0-3s): Frase de impacto ou pergunta
2. **Problema** (3-15s): Identifique a dor rápido
3. **Solução** (15-40s): Dê uma dica real de valor
4. **CTA** (40-60s): "Link na bio" ou "Me chama no direct"

---

## Dicas de Roteiro VSL

- Escreva como fala, não como escreve
- Frases curtas (máximo 15 palavras por frase)
- Uma ideia por frase
- Pausas estratégicas (indique no roteiro)
- Repita a promessa principal pelo menos 3 vezes
- Use a palavra "você" a cada 2-3 frases
- O vídeo ideal tem entre 12 e 20 minutos
