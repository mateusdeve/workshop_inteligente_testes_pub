...
<section id="imagem">
  ...
  <div class="tool" id="heygen">
    ...
    <div class="tool-meta">
      ...
      <div class="meta"><div class="meta-label">Usada por</div><div class="meta-value">/video-heygen, /copy-roteiro</div></div>
    </div>
    <div class="tool-section">
      <h4><i class="ph ph-user-plus"></i>Criar conta</h4>
      <ol>
  ...
  <div class="tool" id="freepik">
    ...
    <div class="tool-meta">
      <div class="meta"><div class="meta-label">Status</div><div class="meta-value"><span class="tag tag-optional">Opcional</span></div></div>
      <div class="meta"><div class="meta-label">Plano</div><div class="meta-value warn">Gratuito limitado</div></div>
      <div class="meta"><div class="meta-label">Usada por</div><div class="meta-value">/img-anuncio, /imagem-prompt</div></div>
    </div>
    <div class="tool-section">
      <h4><i class="ph ph-user-plus"></i>Criar conta</h4>
      <ol>
    ...
    <div class="tool-section">
      ...
      <ol>
        ...
        <li>Cole o prompt gerado pelo comando <span class="inline">/img-anuncio</span> do workshop</li>
  ...
  <div class="tool" id="openrouter">
    ...
    <div class="tool-meta">
      ...
      <div class="meta"><div class="meta-label">Usada por</div><div class="meta-value">/img-anuncio, assets de landing</div></div>
    </div>
    <div class="tool-section">
      <h4><i class="ph ph-user-plus"></i>Criar conta</h4>
      <ol>
  ...
  <div class="tool">
    <table class="env-table">
      ...
      <tbody>
        ...
        <tr><td>Freepik</td><td class="mono">FREEPIK_API_KEY</td><td>Para <span class="inline">/img-anuncio</span></td></tr>
