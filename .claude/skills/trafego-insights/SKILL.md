...
- `ctr_link` (`inline_link_click_ctr`). Vale mais que CTR geral porque exclui clique acidental fora do link.
...
1. `GET /act_{id}/campaigns?fields=id,name,status,objective,daily_budget,lifetime_budget&limit=200&effective_status=['ACTIVE']`
