...
- `meus-produtos/{ativo}/pesquisa-mercado.md` (se existir) → concorrentes HT, faixa de preço, objeções reais do nicho, ângulos virais

Se não houver produto ativo, oriente: "Antes de planejar o High Ticket, você precisa ter seu produto cadastrado. Use `/produto-editar` para criar o perfil do produto."

**Pesquisa de mercado obrigatória:** antes de acionar `/ht-big-idea`, `/ht-oferta`, `/ht-proposta` ou qualquer skill que envolva preço, posicionamento ou quebra de objeção, verifique se `pesquisa-mercado.md` existe e está atualizado (menos de 90 dias). Se não estiver, acione a skill `pesquisa-mercado` antes de continuar. No High Ticket ela é ainda mais crítica: define a faixa de preço real do nicho, mapeia as promessas usadas por concorrentes premium (para você diferenciar a Big Idea) e traz objeções reais que precisam ser antecipadas na proposta e no pitch.
