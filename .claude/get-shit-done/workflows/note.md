...
- **Global scope**: `C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/notes/`)
...
2. Glob `C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/notes/` — works in any directory
