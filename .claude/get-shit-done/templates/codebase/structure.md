...
- Usage: Reference from command with `@C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
