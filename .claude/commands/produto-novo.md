...
> Bloco compartilhado pelos dois ramos. Roda **uma vez**, logo após o produto estar criado e ativado, antes da mensagem final ao aluno. Gera o `painel-entregas.html` do produto com placeholders "Em breve" e atualiza o manifest. O painel será aberto no navegador automaticamente quando o aluno rodar `/produto-concepcao`.
...
O painel ainda não foi aberto no navegador. Ele abre sozinho assim que você rodar `/produto-concepcao`, com a Sala dos Agentes mostrando os agentes preenchendo cada seção em tempo real.
```
