...
4. Clicou em anúncio direto para WhatsApp
5. Seguidor que respondeu post/stories
...
A) Pós-evento:
"[NOME], foi ótimo ter você no [NOME DO EVENTO] hoje. Antes de a gente seguir, queria te fazer uma pergunta: qual parte do que vimos hoje mais fez sentido para o seu momento?"

B) Isca digital:
"[NOME], vi que você baixou [NOME DA ISCA]. Me conta um pouco: o que te levou a procurar isso agora?"

C) Indicação:
"[NOME], [NOME DE QUEM INDICOU] me pediu para entrar em contato. Ele comentou que você está [CONTEXTO]. É isso mesmo?"

D) Anúncio/Stories:
"[NOME], você demonstrou interesse em [TEMA DO ANÚNCIO]. Me conta: qual é o seu momento hoje com isso?"
...
"Entendi. E como está seu [ÁREA RELACIONADA] hoje? Você já tem [ALGO RELACIONADO AO QUADRO] ou ainda está na fase de [PONTO ANTERIOR]?"
...
"E se isso continuar do jeito que está por mais 6 meses, o que acontece?"
...
D+3:
"[NOME], ainda tenho [X] vagas abertas para essa turma. As inscrições fecham [DATA/CONDIÇÃO]. Você quer garantir sua vaga?"

D+7:
"[NOME], essa é minha última mensagem sobre isso. As vagas foram preenchidas / O investimento vai subir para [NOVO PREÇO] a partir de amanhã. Se quiser garantir as condições atuais, me fala agora."
