...
Leia `produtos/.ativo` e `produtos/{ativo}/perfil.md`.
...
```
py -3 scripts/html-to-png.py --input produtos/{ativo}/entregas/furadeira-visual.html --output produtos/{ativo}/entregas/furadeira-visual.png
```
...
with sync_playwright() as p:
    ...
    page.goto('file:///[caminho_absoluto]/produtos/{ativo}/entregas/furadeira-visual.html')
    page.screenshot(path='produtos/{ativo}/entregas/furadeira-visual.png', full_page=True)
    browser.close()
"
```
...
(async () => {
  ...
  await page.goto('file:///[caminho_absoluto]/produtos/{ativo}/entregas/furadeira-visual.html');
  await page.screenshot({path:'produtos/{ativo}/entregas/furadeira-visual.png',fullPage:true});
  await browser.close();
})();
"
```
...
HTML: produtos/{ativo}/entregas/furadeira-visual.html
PNG:  produtos/{ativo}/entregas/furadeira-visual.png

Para visualizar o HTML, cole no navegador:
file:///C:/Users/Elen/.cursor/Imersão IA/workshop_inteligente/produtos/{ativo}/entregas/furadeira-visual.html
```
