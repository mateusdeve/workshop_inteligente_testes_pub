...
1. Mentoria em grupo (sessões coletivas)
2. Mentoria individual (sessões 1:1)
3. Consultoria por projeto
4. Programa completo (curso + acompanhamento)
...
1. WhatsApp individual
2. Grupo no WhatsApp
3. Telegram
4. Plataforma de ensino (Hotmart, Kiwify)
5. Email
...
**MATERIAL COMPLETO DE ONBOARDING HIGH TICKET**
...
2. O que esperar do programa (visão geral)
3. Acesso à plataforma ou grupo (se houver)
4. Data e link da primeira sessão
5. O que fazer antes da primeira sessão
6. Canal de comunicação para dúvidas
...
- Sessões no prazo e preparadas
- Honestidade sobre o que está funcionando e o que precisa mudar

**Nossa garantia mútua:**
O resultado do programa depende da sua implementação. Meu compromisso é estar presente em cada etapa. O seu compromisso é implementar o que combinarmos.
...
- [ ] Adicionado ao grupo (se aplicável)
- [ ] Documento de alinhamento enviado
- [ ] Primeira sessão agendada
- [ ] Formulário de diagnóstico enviado (se aplicável)
