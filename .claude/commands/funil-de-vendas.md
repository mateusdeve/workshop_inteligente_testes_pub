---
name: workshop-marketing:funil-de-vendas
...
3. Low Ticket D48 (quiz + oferta de entrada R$37-97)
...
Anúncio → Quiz → Página Final do Quiz (12 blocos) → Checkout Low Ticket → Upsell
                                                                        ...
                                                                        (não comprou)
                                                                          ...
                                                                          Downsell
```
- Para criar a página final do quiz, use `/low-ticket`
