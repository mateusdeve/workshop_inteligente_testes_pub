---
name: workshop-marketing:zerar-contexto
...
- `produtos/.ativo` — slug do produto ativo
- `produtos/{ativo}/perfil.md` — perfil do produto (se existir pasta)
- `produtos/{ativo}/idconsumidor.md` — identidade do consumidor (se existir pasta)
- `produtos/{ativo}/entregas/` — pasta com todas as entregas do produto (se existir)
...
Use /novo-produto para criar um produto primeiro.
```
E encerre o comando.
...
- Perfil do produto: produtos/curso-tarot/perfil.md
- Identidade do consumidor: produtos/curso-tarot/idconsumidor.md
- Entregas: X arquivos em produtos/curso-tarot/entregas/
...
- Sobrescreva `produtos/{ativo}/perfil.md` com `# Perfil do Negócio`
- Sobrescreva `produtos/{ativo}/idconsumidor.md` com `# Identidade do Consumidor`
...
**Opção 2 — Tudo:**
- Delete todos os arquivos dentro de `produtos/{ativo}/` usando a ferramenta Delete (arquivo por arquivo)
- Esvazie `produtos/.ativo` (grave conteúdo vazio)
...
- Delete todos os arquivos dentro de `produtos/{ativo}/entregas/` usando a ferramenta Delete
- Se existir pasta `entregas/` legada com arquivos, delete os arquivos dentro dela
...
Para começar um novo produto, use /novo-produto.
```
...
Use /meu-produto para preencher o perfil novamente.
```
...
Use /pagina-de-vendas ou /anuncio para gerar novos materiais.
```
