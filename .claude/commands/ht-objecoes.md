...
Para cada objeção, gerar:
- Raiz psicológica (por que o lead diz isso de verdade)
- Resposta modelo (script pronto)
- Como aplicar no contexto do produto
...
Resposta:
"Faz todo sentido. O que especificamente você precisa pensar? Porque talvez eu consiga te ajudar a esclarecer agora."

[Se ele disser "sobre o preço":]
"Entendo. O que está pesando: o valor em si, ou a incerteza sobre o retorno?"

[Se ele disser "sobre o tempo":]
"Quanto tempo você tem disponível por semana? Porque o programa é desenhado para [tempo mínimo]. Muitos dos meus alunos estão na mesma situação que você."
...
Resposta:
"Comparado a quê você está comparando? [aguarde] Quanto está te custando NÃO resolver isso por mês?"

[Se ele der um valor:]
"Em [X meses], são [CÁLCULO]. O investimento no programa é de [PREÇO]. Qual das duas situações é mais cara?"
...
Resposta:
"Faz sentido. O que você acha que [pessoa] vai perguntar sobre isso? Qual a principal preocupação dela?"

[Após a resposta, quebre a objeção que ele imagina que a pessoa teria]

"E se eu te der as respostas para isso agora, você consegue resolver com ele/ela ainda hoje?"
...
Resposta:
"Quanto tempo você tem disponível por semana? [aguarde] O programa foi desenhado para [TEMPO MÍNIMO] por semana. Você tem isso?"

[Se sim:]
"Então o tempo não é o problema real. O que mais está pesando?"
...
Resposta:
"O que especificamente você quer pesquisar? Posso te ajudar a encontrar agora."

[Se for sobre o especialista:]
"O que você precisa ver para ter confiança de que sou a pessoa certa para te ajudar nisso?"
...
Resposta:
"Me conta mais sobre o seu caso. [ouça] Eu trabalhei com [PERFIL SIMILAR]. O resultado foi [RESULTADO]. O seu caso tem [similaridade]. Faz sentido?"
...
Resposta:
"Faz sentido esperar se você precisar de mais tempo para se preparar. Mas me diz: o que muda entre agora e a próxima turma? O problema que você tem hoje vai continuar do mesmo jeito."

[Se houver urgência real:]
"Essa turma fecha em [DATA/CONDIÇÃO]. Na próxima, o investimento será de [PREÇO MAIOR] e não haverá [BÔNUS EXCLUSIVO]."

---

**OBJEÇÕES ESPECÍFICAS DO PRODUTO:**

Gere respostas para as objeções listadas pelo usuário, seguindo a mesma estrutura:
- Raiz psicológica
- Resposta modelo
- Variações para call, WhatsApp e presencial
