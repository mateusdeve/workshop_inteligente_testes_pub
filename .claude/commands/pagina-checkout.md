...
1. Ler `entregas/.ativo` e checar `entregas/{ativo}/.checkout` (se já existe configuração).
...
7. Salvar configuração em `entregas/{ativo}/.checkout`.
8. Backup em `entregas/{ativo}/paginas/.backup-checkout-{timestamp}.html` antes de sobrescrever.
