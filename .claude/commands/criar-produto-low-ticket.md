---
name: workshop-marketing:criar-produto-low-ticket
...
Leia:
- `produtos/.ativo` → se não existir, oriente a usar `/novo-produto` primeiro
- `produtos/{ativo}/perfil.md` → se não existir, oriente a usar `/meu-produto` primeiro

### 2. Verificar formato

Leia `produtos/{ativo}/perfil.md` e identifique se o formato do produto já está definido.
...
- Use /pagina-de-vendas para criar a página de vendas do produto
- Use /anuncio para criar anúncios que levam tráfego à página
```
